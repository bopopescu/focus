...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'User.langauge'
        db.delete_column('user_user', 'langauge')

        # Adding field 'User.language'
        db.add_column('user_user', 'language', self.gf('django.db.models.fields.CharField')(default='nb', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'User.langauge'
        db.add_column('user_user', 'langauge', self.gf('django.db.models.fields.CharField')(default='nb', max_length=30), keep_default=False)

        # Deleting field 'User.language'
        db.delete_column('user_user', 'language')
