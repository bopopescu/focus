...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Notification.creator'
        db.delete_column('core_notification', 'creator_id')

        # Deleting field 'Notification.company'
        db.delete_column('core_notification', 'company_id')

        # Deleting field 'Notification.content_type'
        db.delete_column('core_notification', 'content_type_id')

        # Deleting field 'Notification.date'
        db.delete_column('core_notification', 'date')

        # Deleting field 'Notification.object_id'
        db.delete_column('core_notification', 'object_id')

        # Adding field 'Notification.log'
        db.add_column('core_notification', 'log', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Log'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Notification.creator'
        db.add_column('core_notification', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='createdNotifications', null=True, to=orm['core.User']), keep_default=False)

        # Adding field 'Notification.company'
        db.add_column('core_notification', 'company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notifications', null=True, to=orm['core.Company']), keep_default=False)

        # Adding field 'Notification.content_type'
        db.add_column('core_notification', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True), keep_default=False)

        # Adding field 'Notification.date'
        db.add_column('core_notification', 'date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2011, 2, 19)), keep_default=False)

        # Adding field 'Notification.object_id'
        db.add_column('core_notification', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Deleting field 'Notification.log'
        db.delete_column('core_notification', 'log_id')
    ...
    models = {
        ...
        'core.comment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 23, 4, 53, 713898)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 23, 4, 53, 713934)'}),
