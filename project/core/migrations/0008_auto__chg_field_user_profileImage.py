...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.profileImage'
        db.alter_column('core_user', 'profileImage', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'User.profileImage'
        db.alter_column('core_user', 'profileImage', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
