...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_user', 'first_name', self.gf('django.db.models.fields.CharField')(max_length=60))

        # Changing field 'User.last_name'
        db.alter_column('core_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=60))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'User.last_name'
        db.alter_column('core_user', 'last_name', self.gf('django.db.models.fields.CharField')(max_length=30))
    ...
    models = {
        ...
        'core.comment': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 11, 1, 50, 21, 591463)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 11, 1, 50, 21, 591497)'}),
