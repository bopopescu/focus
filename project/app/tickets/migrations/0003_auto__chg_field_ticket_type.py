...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tickets_ticket', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tickets.TicketType'], null=None))


    def backwards(self, orm):
        
        # Changing field 'Ticket.type'
        db.alter_column('tickets_ticket', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tickets.TicketType']))
    ...
    models = {
        'client.clientuser': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 22, 12, 45, 342572)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 22, 12, 45, 342607)'}),
        ...
        'tickets.ticket': {
            ...
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tickets.TicketType']", 'null': 'None', 'blank': 'True'})
        },
        'tickets.ticketbase': {
