...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field visited_by_since_last_edit on 'Ticket'
        db.create_table('tickets_ticket_visited_by_since_last_edit', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('ticket', models.ForeignKey(orm['tickets.ticket'], null=False)),
            ('user', models.ForeignKey(orm['user.user'], null=False))
        ))
        db.create_unique('tickets_ticket_visited_by_since_last_edit', ['ticket_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field visited_by_since_last_edit on 'Ticket'
        db.delete_table('tickets_ticket_visited_by_since_last_edit')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 13, 21, 27, 53, 950534)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 13, 21, 27, 53, 950590)'}),
