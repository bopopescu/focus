...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketComment.comment'
        db.add_column('tickets_ticketcomment', 'comment', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TicketComment.comment'
        db.delete_column('tickets_ticketcomment', 'comment')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 23, 19, 4, 47, 337334)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 23, 19, 4, 47, 337393)'}),
