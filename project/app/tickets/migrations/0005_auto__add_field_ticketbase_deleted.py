...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TicketBase.deleted'
        db.add_column('tickets_ticketbase', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TicketBase.deleted'
        db.delete_column('tickets_ticketbase', 'deleted')
    ...
    models = {
        'client.clientuser': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 21, 0, 34, 45, 695631)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 21, 0, 34, 45, 695666)'}),
