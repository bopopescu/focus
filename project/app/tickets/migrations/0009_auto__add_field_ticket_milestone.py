...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tickets_ticket', 'milestone', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Milestone'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.milestone'
        db.delete_column('tickets_ticket', 'milestone_id')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 23, 2, 21, 40, 861266)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 10, 23, 2, 21, 40, 861305)'}),
        ...
        'tickets.ticket': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_tickets'", 'null': 'True', 'to': "orm['user.User']"}),
            'attachment': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'}),
            ...
            'visited_by_since_last_edit': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['user.User']", 'symmetrical': 'False'})
        },
        'tickets.ticketbase': {
