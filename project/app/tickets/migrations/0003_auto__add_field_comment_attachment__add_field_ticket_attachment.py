...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tickets_comment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Ticket.attachment'
        db.add_column('tickets_ticket', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Comment.attachment'
        db.delete_column('tickets_comment', 'attachment')

        # Deleting field 'Ticket.attachment'
        db.delete_column('tickets_ticket', 'attachment')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 22, 13, 17, 961743)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 22, 13, 17, 961804)'}),
