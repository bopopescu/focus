...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tickets_ticketupdateline', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 4, 19, 45, 21, 494334))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 4, 19, 45, 21, 494395))),
            ...
            ('update', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tickets.TicketUpdate'])),
    ...
    def backwards(self, orm):
        ...
        db.create_table('tickets_ticketcomment', (
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ticketcomment_created', null=True, to=orm['core.User'], blank=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ticketcomment_edited', null=True, to=orm['core.Company'], blank=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(related_name='comments', to=orm['tickets.Ticket'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 23, 19, 4, 47, 337334))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 2, 23, 19, 4, 47, 337393))),
            ('trashed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ticketcomment_edited', null=True, to=orm['core.User'], blank=True)),
        ))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 19, 45, 21, 494334)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 4, 19, 45, 21, 494395)'}),
        ...
        'tickets.ticketupdateline': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'update': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tickets.TicketUpdate']"})
        }
    }
