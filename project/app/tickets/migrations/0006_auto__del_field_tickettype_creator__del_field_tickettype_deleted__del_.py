...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TicketType.creator'
        db.delete_column('tickets_tickettype', 'creator_id')

        # Deleting field 'TicketType.deleted'
        db.delete_column('tickets_tickettype', 'deleted')

        # Deleting field 'TicketType.editor'
        db.delete_column('tickets_tickettype', 'editor_id')

        # Deleting field 'TicketType.date_created'
        db.delete_column('tickets_tickettype', 'date_created')

        # Deleting field 'TicketType.trashed'
        db.delete_column('tickets_tickettype', 'trashed')

        # Deleting field 'TicketType.date_edited'
        db.delete_column('tickets_tickettype', 'date_edited')


    def backwards(self, orm):
        
        # Adding field 'TicketType.creator'
        db.add_column('tickets_tickettype', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tickettype_created', null=True, to=orm['user.User'], blank=True), keep_default=False)

        # Adding field 'TicketType.deleted'
        db.add_column('tickets_tickettype', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TicketType.editor'
        db.add_column('tickets_tickettype', 'editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='tickettype_edited', null=True, to=orm['user.User'], blank=True), keep_default=False)

        # Adding field 'TicketType.date_created'
        db.add_column('tickets_tickettype', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 21, 0, 34, 45, 695631)), keep_default=False)

        # Adding field 'TicketType.trashed'
        db.add_column('tickets_tickettype', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TicketType.date_edited'
        db.add_column('tickets_tickettype', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 21, 0, 34, 45, 695666)), keep_default=False)
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 21, 1, 39, 14, 345196)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 21, 1, 39, 14, 345244)'}),
        ...
        'tickets.ticket': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['tickets.TicketStatus']"}),
