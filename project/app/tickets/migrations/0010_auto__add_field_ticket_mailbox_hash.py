...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.mailbox_hash'
        db.add_column('tickets_ticket', 'mailbox_hash', self.gf('django.db.models.fields.CharField')(default='', max_length=230), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.mailbox_hash'
        db.delete_column('tickets_ticket', 'mailbox_hash')
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 6, 39, 16, 636303)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 16, 6, 39, 16, 636334)'}),
        ...
        'tickets.ticket': {
            ...
            'mailbox_hash': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '230'}),
