...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Ticket.company'
        db.delete_column('tickets_ticket', 'company_id')

        # Adding field 'TicketBase.company'
        db.add_column('tickets_ticketbase', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['company.Company'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Ticket.company'
        db.add_column('tickets_ticket', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['company.Company']), keep_default=False)

        # Deleting field 'TicketBase.company'
        db.delete_column('tickets_ticketbase', 'company_id')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 14, 38, 16, 321194)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 2, 14, 38, 16, 321245)'}),
