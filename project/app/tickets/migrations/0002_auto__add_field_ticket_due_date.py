...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tickets_ticket', 'due_date', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.due_date'
        db.delete_column('tickets_ticket', 'due_date')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 23, 21, 5, 36, 610357)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 23, 21, 5, 36, 610419)'}),
        ...
        'tickets.ticket': {
            ...
            'due_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
