...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field offers on 'ClientUser'
        db.create_table('client_clientuser_offers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clientuser', models.ForeignKey(orm['client.clientuser'], null=False)),
            ('offer', models.ForeignKey(orm['orders.offer'], null=False))
        ))
        db.create_unique('client_clientuser_offers', ['clientuser_id', 'offer_id'])

        # Adding M2M table for field orders on 'ClientUser'
        db.create_table('client_clientuser_orders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('clientuser', models.ForeignKey(orm['client.clientuser'], null=False)),
            ('order', models.ForeignKey(orm['orders.order'], null=False))
        ))
        db.create_unique('client_clientuser_orders', ['clientuser_id', 'order_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field offers on 'ClientUser'
        db.delete_table('client_clientuser_offers')

        # Removing M2M table for field orders on 'ClientUser'
        db.delete_table('client_clientuser_orders')
    ...
    models = {
        'client.clientuser': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 19, 55, 8114)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 19, 55, 8145)'}),
