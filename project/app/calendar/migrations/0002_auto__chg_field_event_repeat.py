...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.repeat'
        db.alter_column('calendar_event', 'repeat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['calendar.RepeatOption'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Event.repeat'
        db.alter_column('calendar_event', 'repeat_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['calendar.RepeatOption']))
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 0, 52, 7, 51599)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 0, 52, 7, 51634)'}),
            ...
            'repeat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['calendar.RepeatOption']", 'null': 'True'}),
