...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RepeatOption.times'
        db.alter_column('calendar_repeatoption', 'times', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'RepeatOption.times'
        db.alter_column('calendar_repeatoption', 'times', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 6, 5, 15, 501208)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 6, 5, 15, 501246)'}),
