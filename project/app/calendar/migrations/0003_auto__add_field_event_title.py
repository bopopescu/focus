...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('calendar_event', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.title'
        db.delete_column('calendar_event', 'title')
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 4, 11, 28, 822961)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 1, 4, 11, 28, 822992)'}),
