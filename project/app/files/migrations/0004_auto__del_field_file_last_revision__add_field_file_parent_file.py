...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'File.last_revision'
        db.delete_column('files_file', 'last_revision_id')

        # Adding field 'File.parent_file'
        db.add_column('files_file', 'parent_file', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='revisions', null=True, to=orm['files.File']), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'File.last_revision'
        db.add_column('files_file', 'last_revision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['files.File'], blank=True), keep_default=False)

        # Deleting field 'File.parent_file'
        db.delete_column('files_file', 'parent_file_id')
    ...
    models = {
        ...
        'files.file': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 21, 22, 55, 31, 494335)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 21, 22, 55, 31, 494363)'}),
