...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('files_file', 'last_revision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='revisions', null=True, to=orm['files.File']), keep_default=False)
    ...
    models = {
        ...
        'files.file': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 14, 0, 45, 28, 988279)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 14, 0, 45, 28, 988310)'}),
