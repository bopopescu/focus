...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('projects_projectfile', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 11, 13, 17, 17, 27, 608322))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 11, 13, 17, 17, 27, 608362))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projectfile_created', null=True, blank=True, to=orm['auth.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projectfile_edited', null=True, blank=True, to=orm['auth.User'])),
        ...
        db.create_table('projects_projectfolder', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 11, 13, 17, 17, 27, 608322))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 11, 13, 17, 17, 27, 608362))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projectfolder_created', null=True, blank=True, to=orm['auth.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projectfolder_edited', null=True, blank=True, to=orm['auth.User'])),
        ...
        # Changing field 'Project.deleted'
        db.alter_column('projects_project', 'deleted', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.deleted'
        db.alter_column('projects_project', 'deleted', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 13, 17, 17, 27, 608322)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 13, 17, 17, 27, 608362)'}),
