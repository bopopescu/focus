...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('projects_project', 'contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projects', null=True, to=orm['contacts.Contact']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.contact'
        db.delete_column('projects_project', 'contact_id')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 5, 14, 30, 82169)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 5, 14, 30, 82201)'}),
