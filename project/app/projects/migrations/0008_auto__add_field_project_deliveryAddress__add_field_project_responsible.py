...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.deliveryAddress'
        db.add_column('projects_project', 'deliveryAddress', self.gf('django.db.models.fields.CharField')(max_length=150, null=True), keep_default=False)

        # Adding field 'Project.responsible'
        db.add_column('projects_project', 'responsible', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projectsWhereResponsible', null=True, to=orm['auth.User']), keep_default=False)

        # Adding field 'Project.deliveryDate'
        db.add_column('projects_project', 'deliveryDate', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.deliveryDateDeadline'
        db.add_column('projects_project', 'deliveryDateDeadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.deliveryAddress'
        db.delete_column('projects_project', 'deliveryAddress')

        # Deleting field 'Project.responsible'
        db.delete_column('projects_project', 'responsible_id')

        # Deleting field 'Project.deliveryDate'
        db.delete_column('projects_project', 'deliveryDate')

        # Deleting field 'Project.deliveryDateDeadline'
        db.delete_column('projects_project', 'deliveryDateDeadline')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 31, 1, 9, 14, 277240)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 31, 1, 9, 14, 277277)'}),
