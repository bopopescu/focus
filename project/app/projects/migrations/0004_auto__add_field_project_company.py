...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Project.company'
        db.add_column('projects_project', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='projects_project_edited', null=True, blank=True, to=orm['core.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.company'
        db.delete_column('projects_project', 'company_id')
