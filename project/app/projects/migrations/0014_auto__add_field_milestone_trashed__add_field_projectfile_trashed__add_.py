...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Milestone.trashed'
        db.add_column('projects_milestone', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ProjectFile.trashed'
        db.add_column('projects_projectfile', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Project.trashed'
        db.add_column('projects_project', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ProjectFolder.trashed'
        db.add_column('projects_projectfolder', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Milestone.trashed'
        db.delete_column('projects_milestone', 'trashed')

        # Deleting field 'ProjectFile.trashed'
        db.delete_column('projects_projectfile', 'trashed')

        # Deleting field 'Project.trashed'
        db.delete_column('projects_project', 'trashed')

        # Deleting field 'ProjectFolder.trashed'
        db.delete_column('projects_projectfolder', 'trashed')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 51, 34, 288130)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 51, 34, 288166)'}),
