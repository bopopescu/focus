...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('customers_customer', 'city')


    def backwards(self, orm):
        
        # Adding field 'Customer.city'
        db.add_column('customers_customer', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 10, 19, 58, 15, 80622)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 10, 19, 58, 15, 80654)'}),
