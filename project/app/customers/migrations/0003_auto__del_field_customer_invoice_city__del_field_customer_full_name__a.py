...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('customers_customer', 'full_name')

        # Adding field 'Customer.name'
        db.add_column('customers_customer', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('customers_customer', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Deleting field 'Customer.name'
        db.delete_column('customers_customer', 'name')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 10, 20, 8, 50, 247072)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 10, 20, 8, 50, 247103)'}),
