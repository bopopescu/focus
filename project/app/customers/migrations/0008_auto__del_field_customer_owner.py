...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Customer.owner'
        db.delete_column('customers_customer', 'owner_id')


    def backwards(self, orm):
        
        # Adding field 'Customer.owner'
        db.add_column('customers_customer', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='UsersContacts', to=orm['core.User'], blank=True), keep_default=False)
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 41, 24, 1991)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 41, 24, 2038)'}),
