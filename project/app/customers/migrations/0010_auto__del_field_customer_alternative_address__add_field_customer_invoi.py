...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Customer.alternative_address'
        db.delete_column('customers_customer', 'alternative_address')

        # Adding field 'Customer.invoice_address'
        db.add_column('customers_customer', 'invoice_address', self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True), keep_default=False)

        # Adding field 'Customer.invoice_zip'
        db.add_column('customers_customer', 'invoice_zip', self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True), keep_default=False)

        # Adding field 'Customer.invoice_city'
        db.add_column('customers_customer', 'invoice_city', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Changing field 'Customer.zip'
        db.alter_column('customers_customer', 'zip', self.gf('django.db.models.fields.CharField')(max_length=15))


    def backwards(self, orm):
        
        # Adding field 'Customer.alternative_address'
        db.add_column('customers_customer', 'alternative_address', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Deleting field 'Customer.invoice_address'
        db.delete_column('customers_customer', 'invoice_address')

        # Deleting field 'Customer.invoice_zip'
        db.delete_column('customers_customer', 'invoice_zip')

        # Deleting field 'Customer.invoice_city'
        db.delete_column('customers_customer', 'invoice_city')

        # Changing field 'Customer.zip'
        db.alter_column('customers_customer', 'zip', self.gf('django.db.models.fields.CharField')(max_length=4))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 46, 39, 872861)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 46, 39, 872892)'}),
