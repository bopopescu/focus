...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.creator'
        db.alter_column('customers_customer', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))

        # Changing field 'Customer.deleted'
        db.alter_column('customers_customer', 'deleted', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Customer.editor'
        db.alter_column('customers_customer', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))

        # Changing field 'Customer.owner'
        db.alter_column('customers_customer', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, to=orm['core.User']))


    def backwards(self, orm):
        
        # Changing field 'Customer.creator'
        db.alter_column('customers_customer', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))

        # Changing field 'Customer.deleted'
        db.alter_column('customers_customer', 'deleted', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Customer.editor'
        db.alter_column('customers_customer', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))

        # Changing field 'Customer.owner'
        db.alter_column('customers_customer', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], blank=True))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 36, 4, 515547)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 36, 4, 515593)'}),
