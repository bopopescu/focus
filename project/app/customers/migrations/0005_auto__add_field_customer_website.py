...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Customer.website'
        db.add_column('customers_customer', 'website', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Customer.website'
        db.delete_column('customers_customer', 'website')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 5, 43, 382298)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 5, 43, 382338)'}),
