...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Customer.invoice_address'
        db.alter_column('customers_customer', 'invoice_address', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Customer.address'
        db.alter_column('customers_customer', 'address', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Customer.invoice_address'
        db.alter_column('customers_customer', 'invoice_address', self.gf('django.db.models.fields.CharField')(max_length=80))

        # Changing field 'Customer.address'
        db.alter_column('customers_customer', 'address', self.gf('django.db.models.fields.CharField')(max_length=80))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 11, 17, 14, 15, 595561)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 11, 17, 14, 15, 595596)'}),
