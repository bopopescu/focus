...
class Migration(SchemaMigration):
    ...
    # Deleting field 'Customer.birth_date'
        db.delete_column('customers_customer', 'birth_date')

        # Removing M2M table for field projects on 'Customer'
        db.delete_table('customers_customer_projects')

        # Changing field 'Customer.zip'
        db.alter_column('customers_customer', 'zip',
                        self.gf('django.db.models.fields.CharField')(max_length=4, blank=True))


    def backwards(self, orm):

    # Adding field 'Customer.birth_date'
        db.add_column('customers_customer', 'birth_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)
        ...
        # Changing field 'Customer.zip'
        db.alter_column('customers_customer', 'zip',
                        self.gf('django.db.models.fields.IntegerField')(max_length=4, blank=True))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [],
                             {'default': 'datetime.datetime(2010, 10, 7, 14, 46, 30, 248156)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [],
                            {'default': 'datetime.datetime(2010, 10, 7, 14, 46, 30, 248189)'}),
