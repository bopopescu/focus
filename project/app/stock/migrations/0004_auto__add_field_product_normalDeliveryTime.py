...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.normalDeliveryTime'
        db.add_column('stock_product', 'normalDeliveryTime', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Product.normalDeliveryTime'
        db.delete_column('stock_product', 'normalDeliveryTime')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 31, 1, 5, 6, 843146)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 31, 1, 5, 6, 843184)'}),
