...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductFile.parent'
        db.add_column('stock_productfile', 'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name='history', null=True, to=orm['stock.ProductFile']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductFile.parent'
        db.delete_column('stock_productfile', 'parent_id')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 5, 18, 37, 15, 488163)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 5, 18, 37, 15, 488201)'}),
        ...
        'stock.productfile': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'history'", 'null': 'True', 'to': "orm['stock.ProductFile']"}),
