...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.zip'
        db.add_column('suppliers_supplier', 'zip', self.gf('django.db.models.fields.CharField')(default='', max_length=10), keep_default=False)

        # Adding field 'Supplier.email_contact'
        db.add_column('suppliers_supplier', 'email_contact', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'Supplier.email_order'
        db.add_column('suppliers_supplier', 'email_order', self.gf('django.db.models.fields.EmailField')(default='', max_length=75), keep_default=False)

        # Adding field 'Supplier.country'
        db.add_column('suppliers_supplier', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'Supplier.reference'
        db.add_column('suppliers_supplier', 'reference', self.gf('django.db.models.fields.CharField')(default='', max_length=150), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supplier.zip'
        db.delete_column('suppliers_supplier', 'zip')

        # Deleting field 'Supplier.email_contact'
        db.delete_column('suppliers_supplier', 'email_contact')

        # Deleting field 'Supplier.email_order'
        db.delete_column('suppliers_supplier', 'email_order')

        # Deleting field 'Supplier.country'
        db.delete_column('suppliers_supplier', 'country')

        # Deleting field 'Supplier.reference'
        db.delete_column('suppliers_supplier', 'reference')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 25, 27, 904200)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 25, 27, 904232)'}),
