...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.email'
        db.add_column('suppliers_supplier', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)

        # Adding field 'Supplier.phone'
        db.add_column('suppliers_supplier', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True), keep_default=False)

        # Adding field 'Supplier.address'
        db.add_column('suppliers_supplier', 'address', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Supplier.email'
        db.delete_column('suppliers_supplier', 'email')

        # Deleting field 'Supplier.phone'
        db.delete_column('suppliers_supplier', 'phone')

        # Deleting field 'Supplier.address'
        db.delete_column('suppliers_supplier', 'address')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 23, 45, 47, 476841)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 19, 23, 45, 47, 476898)'}),
