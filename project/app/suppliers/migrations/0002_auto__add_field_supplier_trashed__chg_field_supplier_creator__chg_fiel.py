...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Supplier.trashed'
        db.add_column('suppliers_supplier', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'Supplier.creator'
        db.alter_column('suppliers_supplier', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))

        # Changing field 'Supplier.editor'
        db.alter_column('suppliers_supplier', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['core.User']))


    def backwards(self, orm):
        
        # Deleting field 'Supplier.trashed'
        db.delete_column('suppliers_supplier', 'trashed')

        # Changing field 'Supplier.creator'
        db.alter_column('suppliers_supplier', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Supplier.editor'
        db.alter_column('suppliers_supplier', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 52, 27, 915125)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 52, 27, 915159)'}),
