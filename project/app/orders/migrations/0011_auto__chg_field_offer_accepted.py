...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Offer.accepted'
        db.alter_column('orders_offer', 'accepted', self.gf('django.db.models.fields.CharField')(max_length=5, null=True))


    def backwards(self, orm):
        
        # Changing field 'Offer.accepted'
        db.alter_column('orders_offer', 'accepted', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 28, 0, 37, 40, 868721)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 28, 0, 37, 40, 868756)'}),
