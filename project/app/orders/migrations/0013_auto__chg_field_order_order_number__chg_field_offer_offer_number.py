...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'order_number', self.gf('django.db.models.fields.CharField')(max_length=150))

        # Changing field 'Offer.offer_number'
        db.alter_column('orders_offer', 'offer_number', self.gf('django.db.models.fields.CharField')(max_length=150))


    def backwards(self, orm):
        
        # Changing field 'Order.order_number'
        db.alter_column('orders_order', 'order_number', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Offer.offer_number'
        db.alter_column('orders_offer', 'offer_number', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 45, 1, 384853)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 3, 14, 45, 1, 384890)'}),
        ...
        'calendar.repeatoption': {
            ...
            'available_option': ('django.db.models.fields.CharField', [], {'max_length': '10', 'blank': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'repeat_until': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'times': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'company.company': {
        ...
        'orders.invoice': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'invoices'", 'null': 'True', 'to': "orm['projects.Project']"}),
            'status': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '10', 'null': 'True'})
        },
        'orders.offer': {
            'Meta': {'object_name': 'Offer', '_ormbases': ['orders.OrderBase']},
            'accepted': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '5', 'null': 'True'}),
            'offer_number': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'orderbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['orders.OrderBase']", 'unique': 'True', 'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'offers'", 'null': 'True', 'to': "orm['projects.Project']"})
        },
        'orders.order': {
            'Meta': {'object_name': 'Order', '_ormbases': ['orders.OrderBase']},
            'events': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'orders'", 'symmetrical': 'False', 'to': "orm['calendar.Event']"}),
            'offer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'orders'", 'null': 'True', 'to': "orm['orders.Offer']"}),
            'order_number': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'orderbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['orders.OrderBase']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'orders.productline': {
            ...
            'tax': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '10'})
        },
        'projects.project': {
