...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('orders_order', 'project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['projects.Project']), keep_default=False)

        # Adding field 'Offer.project'
        db.add_column('orders_offer', 'project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='offers', null=True, to=orm['projects.Project']), keep_default=False)

        # Adding field 'Invoice.project'
        db.add_column('orders_invoice', 'project', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='invoices', null=True, to=orm['projects.Project']), keep_default=False)

        # Deleting field 'OrderBase.project'
        db.delete_column('orders_orderbase', 'project_id')


    def backwards(self, orm):
        
        # Deleting field 'Order.project'
        db.delete_column('orders_order', 'project_id')

        # Deleting field 'Offer.project'
        db.delete_column('orders_offer', 'project_id')

        # Deleting field 'Invoice.project'
        db.delete_column('orders_invoice', 'project_id')

        # Adding field 'OrderBase.project'
        db.add_column('orders_orderbase', 'project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders', null=True, to=orm['projects.Project'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 22, 23, 5, 525354)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 8, 28, 22, 23, 5, 525386)'}),
