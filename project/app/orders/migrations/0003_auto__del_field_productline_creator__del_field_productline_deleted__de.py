...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProductLine.creator'
        db.delete_column('orders_productline', 'creator_id')

        # Deleting field 'ProductLine.deleted'
        db.delete_column('orders_productline', 'deleted')

        # Deleting field 'ProductLine.editor'
        db.delete_column('orders_productline', 'editor_id')

        # Deleting field 'ProductLine.date_created'
        db.delete_column('orders_productline', 'date_created')

        # Deleting field 'ProductLine.company'
        db.delete_column('orders_productline', 'company_id')

        # Deleting field 'ProductLine.trashed'
        db.delete_column('orders_productline', 'trashed')

        # Deleting field 'ProductLine.date_edited'
        db.delete_column('orders_productline', 'date_edited')


    def backwards(self, orm):
        
        # Adding field 'ProductLine.creator'
        db.add_column('orders_productline', 'creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_created', null=True, to=orm['user.User'], blank=True), keep_default=False)

        # Adding field 'ProductLine.deleted'
        db.add_column('orders_productline', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ProductLine.editor'
        db.add_column('orders_productline', 'editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_edited', null=True, to=orm['user.User'], blank=True), keep_default=False)

        # Adding field 'ProductLine.date_created'
        db.add_column('orders_productline', 'date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 6, 0, 26, 22, 819068)), keep_default=False)

        # Adding field 'ProductLine.company'
        db.add_column('orders_productline', 'company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_companies', null=True, to=orm['company.Company'], blank=True), keep_default=False)

        # Adding field 'ProductLine.trashed'
        db.add_column('orders_productline', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ProductLine.date_edited'
        db.add_column('orders_productline', 'date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 6, 0, 26, 22, 819111)), keep_default=False)
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 7, 2, 9, 41, 404895)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 7, 2, 9, 41, 404933)'}),
