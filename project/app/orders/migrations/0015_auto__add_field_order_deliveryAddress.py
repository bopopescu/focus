...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.deliveryAddress'
        db.add_column('orders_order', 'deliveryAddress', self.gf('django.db.models.fields.CharField')(max_length=150, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.deliveryAddress'
        db.delete_column('orders_order', 'deliveryAddress')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 1, 1, 41, 35, 879559)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 1, 1, 41, 35, 879597)'}),
