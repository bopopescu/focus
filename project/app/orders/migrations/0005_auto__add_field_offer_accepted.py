...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Offer.accepted'
        db.add_column('orders_offer', 'accepted', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Offer.accepted'
        db.delete_column('orders_offer', 'accepted')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 19, 38, 33, 101889)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 20, 19, 38, 33, 101924)'}),
