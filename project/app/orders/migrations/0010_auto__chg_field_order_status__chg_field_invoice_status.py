...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'status', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Invoice.status'
        db.alter_column('orders_invoice', 'status', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Changing field 'Order.status'
        db.alter_column('orders_order', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Invoice.status'
        db.alter_column('orders_invoice', 'status', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 27, 11, 39, 12, 118774)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 9, 27, 11, 39, 12, 118805)'}),
