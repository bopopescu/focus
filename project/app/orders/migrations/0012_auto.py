...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field events on 'Order'
        db.create_table('orders_order_events', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['orders.order'], null=False)),
            ('event', models.ForeignKey(orm['calendar.event'], null=False))
        ))
        db.create_unique('orders_order_events', ['order_id', 'event_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field events on 'Order'
        db.delete_table('orders_order_events')
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 1, 2, 13, 942784)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 11, 2, 1, 2, 13, 942815)'}),
