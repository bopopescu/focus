...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.trashed'
        db.add_column('orders_order', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'OrderFolder.trashed'
        db.add_column('orders_orderfolder', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'OrderFile.trashed'
        db.add_column('orders_orderfile', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Task.trashed'
        db.add_column('orders_task', 'trashed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.trashed'
        db.delete_column('orders_order', 'trashed')

        # Deleting field 'OrderFolder.trashed'
        db.delete_column('orders_orderfolder', 'trashed')

        # Deleting field 'OrderFile.trashed'
        db.delete_column('orders_orderfile', 'trashed')

        # Deleting field 'Task.trashed'
        db.delete_column('orders_task', 'trashed')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 52, 20, 872629)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 9, 16, 52, 20, 872664)'}),
