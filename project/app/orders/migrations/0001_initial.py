...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('orders_productline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trashed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 23, 20, 19, 356697))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 23, 20, 19, 356734))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_created', null=True, blank=True, to=orm['user.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_edited', null=True, blank=True, to=orm['user.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='productline_companies', null=True, blank=True, to=orm['company.Company'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='product_lines', to=orm['stock.Product'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('price', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('orders', ['ProductLine'])

        # Adding model 'OrderBase'
        db.create_table('orders_orderbase', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trashed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 23, 20, 19, 356697))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 5, 23, 20, 19, 356734))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='orderbase_created', null=True, blank=True, to=orm['user.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='orderbase_edited', null=True, blank=True, to=orm['user.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='orderbase_companies', null=True, blank=True, to=orm['company.Company'])),
            ...
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('delivery_address', self.gf('django.db.models.fields.CharField')(max_length=150, null=True)),
            ('PO_number', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
        ...
        db.send_create_signal('orders', ['OrderBase'])

        # Adding M2M table for field product_lines on 'OrderBase'
        db.create_table('orders_orderbase_product_lines', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('orderbase', models.ForeignKey(orm['orders.orderbase'], null=False)),
            ('productline', models.ForeignKey(orm['orders.productline'], null=False))
        ))
        db.create_unique('orders_orderbase_product_lines', ['orderbase_id', 'productline_id'])

        # Adding model 'Invoice'
        db.create_table('orders_invoice', (
            ('orderbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.OrderBase'], unique=True, primary_key=True)),
            ('invoice_number', self.gf('django.db.models.fields.IntegerField')()),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', to=orm['orders.Order'])),
        ))
        db.send_create_signal('orders', ['Invoice'])

        # Adding model 'Offer'
        db.create_table('orders_offer', (
            ('orderbase_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['orders.OrderBase'], unique=True, primary_key=True)),
            ('offer_number', self.gf('django.db.models.fields.IntegerField')()),
        ))
        ...
        db.create_table('orders_order', (
            ...
            ('offer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='orders', null=True, to=orm['orders.Offer'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('orders_productline')

        # Deleting model 'OrderBase'
        db.delete_table('orders_orderbase')

        # Removing M2M table for field product_lines on 'OrderBase'
        db.delete_table('orders_orderbase_product_lines')

        # Deleting model 'Invoice'
        db.delete_table('orders_invoice')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 20, 19, 356697)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 20, 19, 356734)'}),
        ...
        'orders.productline': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'productline_companies'", 'null': 'True', 'blank': 'True', 'to': "orm['company.Company']"}),
            'count': ('django.db.models.fields.IntegerField', [], {}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'productline_created'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 20, 19, 356697)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 5, 23, 20, 19, 356734)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'productline_edited'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'product_lines'", 'to': "orm['stock.Product']"}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'projects.project': {
