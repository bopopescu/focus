...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderMembership'
        db.create_table('orders_ordermembership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trashed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 12, 17, 0, 9, 23, 684118))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 12, 17, 0, 9, 23, 684151))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ordermembership_created', null=True, blank=True, to=orm['user.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ordermembership_edited', null=True, blank=True, to=orm['user.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='ordermembership_companies', null=True, blank=True, to=orm['company.Company'])),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='memberships', to=orm['orders.Order'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='orders_memberships', to=orm['user.User'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('work_done', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('orders', ['OrderMembership'])


    def backwards(self, orm):
        
        # Deleting model 'OrderMembership'
        db.delete_table('orders_ordermembership')
    ...
    models = {
        'calendar.event': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 17, 0, 9, 23, 684118)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 17, 0, 9, 23, 684151)'}),
        ...
        'orders.offer': {
            ...
            'offer_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150'}),
            'orderbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['orders.OrderBase']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'orders.order': {
            ...
            'order_number': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '150'}),
            'orderbase_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['orders.OrderBase']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        'orders.ordermembership': {
            'Meta': {'object_name': 'OrderMembership'},
            'company': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'ordermembership_companies'", 'null': 'True', 'blank': 'True', 'to': "orm['company.Company']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'ordermembership_created'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 17, 0, 9, 23, 684118)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 17, 0, 9, 23, 684151)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'ordermembership_edited'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'memberships'", 'to': "orm['orders.Order']"}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders_memberships'", 'to': "orm['user.User']"}),
            'work_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'orders.productline': {
