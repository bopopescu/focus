...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['customers.Customer']))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 30, 3, 31, 3, 374288)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 30, 3, 31, 3, 374325)'}),
