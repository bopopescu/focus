...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field files on 'OrderBase'
        db.create_table('orders_orderbase_files', (
        ...
        db.create_unique('orders_orderbase_files', ['orderbase_id', 'file_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field files on 'OrderBase'
        db.delete_table('orders_orderbase_files')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 23, 10, 27, 19, 811311)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 23, 10, 27, 19, 811346)'}),
