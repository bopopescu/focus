...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Contact.phone_office'
        db.add_column('contacts_contact', 'phone_office', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)

        # Adding field 'Contact.phone_mobile'
        db.add_column('contacts_contact', 'phone_mobile', self.gf('django.db.models.fields.CharField')(default='', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.phone_office'
        db.delete_column('contacts_contact', 'phone_office')

        # Deleting field 'Contact.phone_mobile'
        db.delete_column('contacts_contact', 'phone_mobile')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 18, 24, 304134)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 4, 18, 24, 304172)'}),
