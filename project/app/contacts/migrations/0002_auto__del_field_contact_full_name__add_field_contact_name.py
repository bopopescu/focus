...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('contacts_contact', 'full_name')

        # Adding field 'Contact.name'
        db.add_column('contacts_contact', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Contact.full_name'
        db.add_column('contacts_contact', 'full_name', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)

        # Deleting field 'Contact.name'
        db.delete_column('contacts_contact', 'name')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 11, 19, 49, 26, 778715)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 11, 19, 49, 26, 778745)'}),
