...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HourRegistrationType'
        db.create_table('hourregistrations_hourregistrationtype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('trashed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 8, 16, 27, 45, 254563))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 8, 16, 27, 45, 254591))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hourregistrationtype_created', null=True, blank=True, to=orm['user.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hourregistrationtype_edited', null=True, blank=True, to=orm['user.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='hourregistrationtype_companies', null=True, blank=True, to=orm['company.Company'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('hourregistrations', ['HourRegistrationType'])
        ...
        db.create_table('hourregistrations_hourregistration', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hourregistrations', null=True, to=orm['orders.Order'])),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='hourregistrations', null=True, to=orm['tickets.Ticket'])),
            ('type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hourregistrations', to=orm['hourregistrations.HourRegistrationType'])),
        ...
        db.create_table('hourregistrations_disbursement', (
            ...
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='disbursements', null=True, to=orm['orders.Order'])),
            ('description', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2)),
            ('count', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=1)),
            ('attachment', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'HourRegistrationType'
        db.delete_table('hourregistrations_hourregistrationtype')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 16, 27, 45, 254563)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 7, 8, 16, 27, 45, 254591)'}),
        ...
        'hourregistrations.disbursement': {
            ...
            'count': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '1'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'disbursements'", 'null': 'True', 'to': "orm['orders.Order']"}),
            'rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2'}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'hourregistrations.hourregistration': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hourregistrations'", 'null': 'True', 'to': "orm['orders.Order']"}),
        ...
        'hourregistrations.hourregistrationtype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'rate': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '2'}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        'orders.offer': {
