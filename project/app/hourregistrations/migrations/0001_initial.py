...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hourregistrations_typeofhourregistration', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 16, 5, 45, 37, 672521))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 16, 5, 45, 37, 672554))),
        ...
        db.create_table('hourregistrations_hourregistration', (
            ...
            ('savedHours', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=5, decimal_places=3)),
            ('usedOfSavedHours', self.gf('django.db.models.fields.DecimalField')(default='0.0', max_digits=5, decimal_places=3)),
        ))
        ...
        db.create_table('hourregistrations_drivingregistration', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 16, 5, 45, 37, 672521))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 16, 5, 45, 37, 672554))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='drivingregistration_created', null=True, blank=True, to=orm['core.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='drivingregistration_edited', null=True, blank=True, to=orm['core.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='drivingregistration_edited', null=True, blank=True, to=orm['core.Company'])),
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 5, 45, 37, 672521)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 16, 5, 45, 37, 672554)'}),
