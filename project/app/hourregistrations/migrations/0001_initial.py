...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hourregistrations_typeofhourregistration', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 4, 11, 1, 53, 38, 368706))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 4, 11, 1, 53, 38, 368739))),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='typeofhourregistration_created', null=True, blank=True, to=orm['user.User'])),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='typeofhourregistration_edited', null=True, blank=True, to=orm['user.User'])),
            ('company', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='typeofhourregistration_companies', null=True, blank=True, to=orm['company.Company'])),
        ...
        db.create_table('hourregistrations_hourregistration', (
            ...
            ('typeOfWork', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['hourregistrations.TypeOfHourRegistration'])),
            ...
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('pause', self.gf('django.db.models.fields.DecimalField')(default='0.5', max_digits=5, decimal_places=3)),
            ('hourly_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3)),
            ('percent_cover', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3)),
            ('hours_worked', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3)),
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 11, 1, 53, 38, 368706)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 11, 1, 53, 38, 368739)'}),
        ...
        'hourregistrations.typeofhourregistration': {
            ...
            'company': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'typeofhourregistration_companies'", 'null': 'True', 'blank': 'True', 'to': "orm['company.Company']"}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'typeofhourregistration_created'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 11, 1, 53, 38, 368706)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 11, 1, 53, 38, 368739)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'typeofhourregistration_edited'", 'null': 'True', 'blank': 'True', 'to': "orm['user.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'trashed': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
