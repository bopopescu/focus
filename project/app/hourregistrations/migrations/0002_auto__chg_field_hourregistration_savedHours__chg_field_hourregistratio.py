...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HourRegistration.savedHours'
        db.alter_column('hourregistrations_hourregistration', 'savedHours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))

        # Changing field 'HourRegistration.usedOfSavedHours'
        db.alter_column('hourregistrations_hourregistration', 'usedOfSavedHours', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'HourRegistration.savedHours'
        db.alter_column('hourregistrations_hourregistration', 'savedHours', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))

        # Changing field 'HourRegistration.usedOfSavedHours'
        db.alter_column('hourregistrations_hourregistration', 'usedOfSavedHours', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=3))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 1, 47, 12, 366992)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 25, 1, 47, 12, 367026)'}),
