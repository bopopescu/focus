...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DrivingRegistration.description'
        db.alter_column('hourregistrations_drivingregistration', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Adding field 'HourRegistration.pause'
        db.add_column('hourregistrations_hourregistration', 'pause', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=3), keep_default=False)

        # Adding field 'HourRegistration.savedHours'
        db.add_column('hourregistrations_hourregistration', 'savedHours', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=3), keep_default=False)

        # Adding field 'HourRegistration.usedOfSavedHours'
        db.add_column('hourregistrations_hourregistration', 'usedOfSavedHours', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=3), keep_default=False)

        # Changing field 'HourRegistration.hourly_rate'
        db.alter_column('hourregistrations_hourregistration', 'hourly_rate', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))

        # Changing field 'HourRegistration.percent_cover'
        db.alter_column('hourregistrations_hourregistration', 'percent_cover', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=3))


    def backwards(self, orm):
        
        # Changing field 'DrivingRegistration.description'
        db.alter_column('hourregistrations_drivingregistration', 'description', self.gf('django.db.models.fields.TextField')())

        # Deleting field 'HourRegistration.pause'
        db.delete_column('hourregistrations_hourregistration', 'pause')

        # Deleting field 'HourRegistration.savedHours'
        db.delete_column('hourregistrations_hourregistration', 'savedHours')

        # Deleting field 'HourRegistration.usedOfSavedHours'
        db.delete_column('hourregistrations_hourregistration', 'usedOfSavedHours')

        # Changing field 'HourRegistration.hourly_rate'
        db.alter_column('hourregistrations_hourregistration', 'hourly_rate', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'HourRegistration.percent_cover'
        db.alter_column('hourregistrations_hourregistration', 'percent_cover', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 8, 15, 58, 47, 241420)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 8, 15, 58, 47, 241468)'}),
        ...
        'hourregistrations.hourregistration': {
            ...
            'pause': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '3'}),
            'percent_cover': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '5', 'decimal_places': '3'}),
            'savedHours': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '3'}),
            'time_end': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'time_start': ('django.db.models.fields.CharField', [], {'max_length': '5'}),
            'typeOfWork': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['hourregistrations.TypeOfHourRegistration']"}),
            'usedOfSavedHours': ('django.db.models.fields.DecimalField', [], {'max_digits': '5', 'decimal_places': '3'})
        },
