...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('hourregistrations_drivingregistration', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 5, 4, 25, 4, 641119))),
            ('date_edited', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 1, 5, 4, 25, 4, 641172))),
        ...
        db.alter_column('hourregistrations_disbursement', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 5, 4, 25, 4, 641119)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 5, 4, 25, 4, 641172)'}),
