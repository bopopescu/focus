...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.image'
        db.add_column('bugreporting_bug', 'image', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bug.image'
        db.delete_column('bugreporting_bug', 'image')
    ...
    models = {
        ...
        'bugreporting.bug': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 6, 23, 22, 42, 809826)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 6, 23, 22, 42, 809859)'}),
