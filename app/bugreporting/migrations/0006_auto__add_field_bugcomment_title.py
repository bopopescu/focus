...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BugComment.title'
        db.add_column('bugreporting_bugcomment', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=80), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BugComment.title'
        db.delete_column('bugreporting_bugcomment', 'title')
    ...
    models = {
        ...
        'bugreporting.bug': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 1, 12, 25, 23, 434156)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 1, 12, 25, 23, 434207)'}),
