...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BugComment.image'
        db.add_column('bugreporting_bugcomment', 'image', self.gf('django.db.models.fields.files.FileField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BugComment.image'
        db.delete_column('bugreporting_bugcomment', 'image')
    ...
    models = {
        ...
        'bugreporting.bug': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 6, 23, 32, 11, 631210)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 6, 23, 32, 11, 631243)'}),
