...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bug.closed'
        db.add_column('bugreporting_bug', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bug.closed'
        db.delete_column('bugreporting_bug', 'closed')
    ...
    models = {
        ...
        'bugreporting.bug': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 25, 1, 58, 19, 803280)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 25, 1, 58, 19, 803327)'}),
