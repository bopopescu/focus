...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.deleted'
        db.alter_column('contacts_contact', 'deleted', self.gf('django.db.models.fields.BooleanField')())


    def backwards(self, orm):
        
        # Changing field 'Contact.deleted'
        db.alter_column('contacts_contact', 'deleted', self.gf('django.db.models.fields.BooleanField')(blank=True))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 12, 16, 51, 7, 454599)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 9, 12, 16, 51, 7, 454637)'}),
