...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('orders_order', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['customers.Customer']))


    def backwards(self, orm):
        
        # Changing field 'Order.customer'
        db.alter_column('orders_order', 'customer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['customers.Customer'], blank=True))
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 59, 19, 429413)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 59, 19, 429449)'}),
        ...
        'orders.order': {
            ...
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'orders'", 'to': "orm['customers.Customer']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 59, 19, 429413)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 23, 59, 19, 429449)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
