...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.deliveryDateDeadline'
        db.alter_column('projects_project', 'deliveryDateDeadline', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))

        # Changing field 'Project.deliveryDate'
        db.alter_column('projects_project', 'deliveryDate', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Project.deliveryDateDeadline'
        db.alter_column('projects_project', 'deliveryDateDeadline', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

        # Changing field 'Project.deliveryDate'
        db.alter_column('projects_project', 'deliveryDate', self.gf('django.db.models.fields.DateField')(null=True, blank=True))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 28, 2, 43, 54, 455459)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 28, 2, 43, 54, 455497)'}),
        ...
        'core.user': {
            ...
            'validEditBackToDate': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'validEditBackToDateExpire': ('django.db.models.fields.DateField', [], {'null': 'True'})
        },
        'customers.customer': {
