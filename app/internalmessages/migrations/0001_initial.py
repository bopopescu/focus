...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('internalmessages_internalmessage', (
            ...
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sendtMessages', to=orm['auth.User'])),
        ))
        db.send_create_signal('internalmessages', ['InternalMessage'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('internalmessages_internalmessage')
    ...
    models = {
        ...
        'internalmessages.internalmessage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipients': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'recievedMessages'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
