...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TypeOfTimeTracking.creator'
        db.alter_column('timetracking_typeoftimetracking', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))

        # Changing field 'TypeOfTimeTracking.deleted'
        db.alter_column('timetracking_typeoftimetracking', 'deleted', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'TypeOfTimeTracking.editor'
        db.alter_column('timetracking_typeoftimetracking', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))

        # Changing field 'Timetracking.creator'
        db.alter_column('timetracking_timetracking', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))

        # Changing field 'Timetracking.deleted'
        db.alter_column('timetracking_timetracking', 'deleted', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Timetracking.editor'
        db.alter_column('timetracking_timetracking', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, blank=True, to=orm['core.User']))


    def backwards(self, orm):
        
        # Changing field 'TypeOfTimeTracking.creator'
        db.alter_column('timetracking_typeoftimetracking', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))

        # Changing field 'TypeOfTimeTracking.deleted'
        db.alter_column('timetracking_typeoftimetracking', 'deleted', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'TypeOfTimeTracking.editor'
        db.alter_column('timetracking_typeoftimetracking', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))

        # Changing field 'Timetracking.creator'
        db.alter_column('timetracking_timetracking', 'creator_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))

        # Changing field 'Timetracking.deleted'
        db.alter_column('timetracking_timetracking', 'deleted', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Timetracking.editor'
        db.alter_column('timetracking_timetracking', 'editor_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User'], blank=True))
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295680)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295727)'}),
        ...
        'timetracking.timetracking': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'timetracking_created'", 'null': 'True', 'blank': 'True', 'to': "orm['core.User']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295680)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295727)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'timetracking_edited'", 'null': 'True', 'blank': 'True', 'to': "orm['core.User']"}),
            ...
            'typeOfWork': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['timetracking.TypeOfTimeTracking']"})
        },
        'timetracking.typeoftimetracking': {
            ...
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'typeoftimetracking_created'", 'null': 'True', 'blank': 'True', 'to': "orm['core.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295680)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 2, 35, 54, 295727)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'typeoftimetracking_edited'", 'null': 'True', 'blank': 'True', 'to': "orm['core.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
