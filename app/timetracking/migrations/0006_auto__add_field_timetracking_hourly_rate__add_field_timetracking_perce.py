...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Timetracking.hourly_rate'
        db.add_column('timetracking_timetracking', 'hourly_rate', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Timetracking.percent_cover'
        db.add_column('timetracking_timetracking', 'percent_cover', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Timetracking.hourly_rate'
        db.delete_column('timetracking_timetracking', 'hourly_rate')

        # Deleting field 'Timetracking.percent_cover'
        db.delete_column('timetracking_timetracking', 'percent_cover')
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 5, 19, 16, 655990)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 5, 19, 16, 656036)'}),
