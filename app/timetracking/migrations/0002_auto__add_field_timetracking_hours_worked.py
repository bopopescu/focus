...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Timetracking.hours_worked'
        db.add_column('timetracking_timetracking', 'hours_worked', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Timetracking.hours_worked'
        db.delete_column('timetracking_timetracking', 'hours_worked')
    ...
    models = {
        ...
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 7, 23, 11, 47, 567333)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 7, 23, 11, 47, 567365)'}),
        ...
        'timetracking.timetracking': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2010, 10, 7, 23, 11, 47, 596730)'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 7, 23, 11, 47, 567333)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 7, 23, 11, 47, 567365)'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'hours_worked': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
