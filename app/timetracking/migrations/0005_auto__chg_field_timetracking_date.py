...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Timetracking.date'
        db.alter_column('timetracking_timetracking', 'date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Timetracking.date'
        db.alter_column('timetracking_timetracking', 'date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        'contacts.contact': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 3, 26, 49, 392715)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 4, 3, 26, 49, 392763)'}),
