...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.hoursNeededFor50overtimePay'
        db.add_column('core_company', 'hoursNeededFor50overtimePay', self.gf('django.db.models.fields.IntegerField')(default=160), keep_default=False)

        # Adding field 'Company.hoursNeededFor100overtimePay'
        db.add_column('core_company', 'hoursNeededFor100overtimePay', self.gf('django.db.models.fields.IntegerField')(default=240), keep_default=False)

        # Adding field 'Company.periodeHourRegistrations'
        db.add_column('core_company', 'periodeHourRegistrations', self.gf('django.db.models.fields.CharField')(default='m', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.hoursNeededFor50overtimePay'
        db.delete_column('core_company', 'hoursNeededFor50overtimePay')

        # Deleting field 'Company.hoursNeededFor100overtimePay'
        db.delete_column('core_company', 'hoursNeededFor100overtimePay')

        # Deleting field 'Company.periodeHourRegistrations'
        db.delete_column('core_company', 'periodeHourRegistrations')
