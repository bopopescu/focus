...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ObjectPermission.can_modifyPermissions'
        db.add_column('core_objectpermission', 'can_modifyPermissions', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ObjectPermission.can_modifyPermissions'
        db.delete_column('core_objectpermission', 'can_modifyPermissions')
    ...
    models = {
        ...
        'core.membership': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 24, 17, 37, 23, 242904)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 24, 17, 37, 23, 242943)'}),
        ...
        'core.objectpermission': {
            ...
            'can_modifyPermissions': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
