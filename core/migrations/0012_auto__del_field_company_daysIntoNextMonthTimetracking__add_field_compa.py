...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Company.daysIntoNextMonthTimetracking'
        db.delete_column('core_company', 'daysIntoNextMonthTimetracking')

        # Adding field 'Company.daysIntoNextMonthTypeOfHourRegistration'
        db.add_column('core_company', 'daysIntoNextMonthTypeOfHourRegistration', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Deleting field 'User.daysIntoNextMonthTimetracking'
        db.delete_column('core_user', 'daysIntoNextMonthTimetracking')

        # Deleting field 'User.daysIntoNextMonthTimetrackingExpire'
        db.delete_column('core_user', 'daysIntoNextMonthTimetrackingExpire')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Company.daysIntoNextMonthTimetracking'
        db.add_column('core_company', 'daysIntoNextMonthTimetracking', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)
        ...
        # Adding field 'User.daysIntoNextMonthTimetracking'
        db.add_column('core_user', 'daysIntoNextMonthTimetracking', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'User.daysIntoNextMonthTimetrackingExpire'
        db.add_column('core_user', 'daysIntoNextMonthTimetrackingExpire', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)
