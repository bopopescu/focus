...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Permission.negative'
        db.add_column('core_permission', 'negative', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Permission.from_date'
        db.add_column('core_permission', 'from_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Permission.to_date'
        db.add_column('core_permission', 'to_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Permission.negative'
        db.delete_column('core_permission', 'negative')

        # Deleting field 'Permission.from_date'
        db.delete_column('core_permission', 'from_date')

        # Deleting field 'Permission.to_date'
        db.delete_column('core_permission', 'to_date')
