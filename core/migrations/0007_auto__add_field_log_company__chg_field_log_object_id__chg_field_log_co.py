...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Log.company'
        db.add_column('core_log', 'company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', null=True, to=orm['core.Company']), keep_default=False)

        # Changing field 'Log.object_id'
        db.alter_column('core_log', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Log.content_type'
        db.alter_column('core_log', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))


    def backwards(self, orm):
        
        # Deleting field 'Log.company'
        db.delete_column('core_log', 'company_id')

        # Changing field 'Log.object_id'
        db.alter_column('core_log', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Log.content_type'
        db.alter_column('core_log', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType']))
    ...
    models = {
        ...
        'core.membership': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 21, 34, 52, 134118)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 10, 28, 21, 34, 52, 134150)'}),
