...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_user', 'hourly_rate', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'User.percent_cover'
        db.add_column('core_user', 'percent_cover', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.hourly_rate'
        db.delete_column('core_user', 'hourly_rate')

        # Deleting field 'User.percent_cover'
        db.delete_column('core_user', 'percent_cover')
