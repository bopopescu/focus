...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Log.action'
        db.add_column('core_log', 'action', self.gf('django.db.models.fields.CharField')(max_length=10, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Log.action'
        db.delete_column('core_log', 'action')
    ...
    models = {
        ...
        'core.membership': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 6, 15, 38, 15, 341423)'}),
            'date_edited': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 6, 15, 38, 15, 341460)'}),
