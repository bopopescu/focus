...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.company'
        db.add_column('core_group', 'company', self.gf('django.db.models.fields.related.ForeignKey')(related_name='groups', null=True, to=orm['core.Company']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.company'
        db.delete_column('core_group', 'company_id')
