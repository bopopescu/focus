...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User.deleted'
        db.add_column('core_user', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'User.deleted'
        db.delete_column('core_user', 'deleted')
