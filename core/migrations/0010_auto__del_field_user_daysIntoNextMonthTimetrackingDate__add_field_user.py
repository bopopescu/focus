...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'User.daysIntoNextMonthTimetrackingDate'
        db.delete_column('core_user', 'daysIntoNextMonthTimetrackingDate')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'User.daysIntoNextMonthTimetrackingDate'
        db.add_column('core_user', 'daysIntoNextMonthTimetrackingDate', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)
