...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.MonthsStillValidForEditWhenEditing'
        db.add_column('core_company', 'MonthsStillValidForEditWhenEditing', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Company.DayInMonthsStillValidForEditWhenEditing'
        db.add_column('core_company', 'DayInMonthsStillValidForEditWhenEditing', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Changing field 'Company.daysIntoNextMonthTypeOfHourRegistration'
        db.alter_column('core_company', 'daysIntoNextMonthTypeOfHourRegistration', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Deleting field 'Company.MonthsStillValidForEditWhenEditing'
        db.delete_column('core_company', 'MonthsStillValidForEditWhenEditing')

        # Deleting field 'Company.DayInMonthsStillValidForEditWhenEditing'
        db.delete_column('core_company', 'DayInMonthsStillValidForEditWhenEditing')

        # Changing field 'Company.daysIntoNextMonthTypeOfHourRegistration'
        db.alter_column('core_company', 'daysIntoNextMonthTypeOfHourRegistration', self.gf('django.db.models.fields.IntegerField')(null=True))
    ...
    models = {
        ...
        'core.company': {
            'DayInMonthsStillValidForEditWhenEditing': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'Meta': {'object_name': 'Company'},
            'MonthsStillValidForEditWhenEditing': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            ...
            'daysIntoNextMonthTypeOfHourRegistration': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
