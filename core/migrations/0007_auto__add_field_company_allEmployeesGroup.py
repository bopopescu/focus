...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Company.allEmployeesGroup'
        db.add_column('core_company', 'allEmployeesGroup', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='companiesWhereAllEmployeed', null=True, to=orm['core.Group']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Company.allEmployeesGroup'
        db.delete_column('core_company', 'allEmployeesGroup_id')
